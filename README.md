...
1) Download the registry file ([as zip](https://cdn.jsdelivr.net/gh/FastForwardTeam/releases@main/winreg/allow_ff.zip) to allow installation on windows. (this link will be edited after this pr get's merged.)
...
4) Download the [latest version of the extension](https://cdn.jsdelivr.net/gh/FastForwardTeam/releases@main/update/FastForward.crx).
...
2) Download the [latest version of the extension](https://cdn.jsdelivr.net/gh/FastForwardTeam/releases@main/update/FastForward.crx).
